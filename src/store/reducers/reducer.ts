    ...
    resume: {
        ...
        tools: [
            ...
            },
            {
                name: 'Technologies',
                list:
                    'Spring MVC, Node.js, React.js, AngularJS, Express.js, jQuery, Git, npm',
            },
            {
    ...
    sections: [
        {
            ...
            projects: [
                ...
                },
                {
                    ...
                    image:
                        'https://assets.mongodb-cdn.com/mms/static/dist/images/e5f9c604b34c4b83eca2708fde2314b5.svg',
                    links: [
                        {
                            label: 'Check It Out',
                ...
                },
                {
                    ...
                    image:
                        'https://assets.website-files.com/6194c620b350c4056027fac7/62f4d43c3eac4d1d01e6e038_mongodb-atlas-logo.png',
                    links: [
                        {
                            label: 'Check It Out',
            ...
            projects: [
                {
                    ...
                    image:
                        'https://akshaysadarangani.com/images/Projects/Autometa.png',
                    links: [
                        {
                            label: 'Check It Out',
                ...
                },
                {
                    ...
                    image:
                        'https://akshaysadarangani.com/images/Projects/news.jpg',
                    links: [
                        {
                            label: 'Check It Out',
